...
class FakeBMS():
    def __init__(self, name, i):
        ...
        self.dbusService.add_path('/ProductName', "EMS Fake BMS {}".format(i)) 
        self.dbusService.add_path('/CustomName', "EMS Fake BMS {}".format(i), writeable=True) 
