...
logger.propagate = False #Avoid floading system_calc_logs.
#end debug purpose
...
#TODO: Simulation preparations
# - Creata a multi-ideal-mock.
# - Parameter for TimeModifier to speed up simulating