...
class MotorDriveConsumptionTest(TestSystemCalcBase):
	...
	def test_basic(self):
		...
		self.simulate_steps(
			[
				# travelling 1km at 1000W, following a 45 degree bearing
				[60000, 100, 45, 1000],
				[60000, 100, 45, 1000],
				[60000, 100, 45, 1000],
				[60000, 100, 45, 1000],
	...
	def test_too_slow(self):
		...
		self.simulate_steps(
			[
				...
				[60000, 100, 45, 1000],
				[60000, 100, 45, 1000],
				[1000, 0.2, 0, 1000], # below minimum speed, should be ignored
				[1000, 0.2, 0, 1000], # below minimum speed, should be ignored
				[60000, 100, 45, 1000],
				[60000, 100, 45, 1000],
				[60000, 100, 45, 1000],
	...
	def test_bearing_turn_too_quick(self):
		...
		self.simulate_steps(
			[
				...
				[1000, 10, 0, 1000], # above bearing change threshold, should be ignored
				[10000, 10, 0, 1000], # above bearing change threshold, delta time large enough to reset
				[60000, 100, 45, 1000],
				[60000, 100, 45, 1000],
				[60000, 100, 45, 1000],
				[60000, 100, 45, 1000],
