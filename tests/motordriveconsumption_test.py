...
class MotorDriveConsumptionTest(TestSystemCalcBase):
	...
	def test_basic(self):
		...
		self._check_values(
			{
				...
				"/MotorDrive/ConsumptionWhkm": None,
				"/MotorDrive/ConsumptionAhkm": None,
			}
		)
		...
		self._check_values(
			{
				"/GpsService": "com.victronenergy.gps.ttyX2",
				"/MotorDrive/ConsumptionWhkm": 166.66666666666663,  # Wh/km
				"/MotorDrive/ConsumptionAhkm": 3.5000000000000004,  # Ah/km
			}
		)
		...
		self._check_values(
			{
				"/GpsService": "com.victronenergy.gps.ttyX2",
				"/MotorDrive/ConsumptionWhkm": 166.66666666666663,  # Wh/km
				"/MotorDrive/ConsumptionAhkm": 3.499999999999999,  # Ah/km
			}
		)
	...
	def test_too_fast(self):
		...
		self._check_values(
			{
				"/GpsService": "com.victronenergy.gps.ttyX2",
				"/MotorDrive/ConsumptionWhkm": 239.09107369183417,  # Wh/km
				"/MotorDrive/ConsumptionAhkm": 5.020912547528517,  # Ah/km
			}
		)
		...
		self._check_values(
			{
				"/GpsService": "com.victronenergy.gps.ttyX2",
				"/MotorDrive/ConsumptionWhkm": 166.66666666666663,  # Wh/km
				"/MotorDrive/ConsumptionAhkm": 3.4999999999999996,  # Ah/km
			}
		)
