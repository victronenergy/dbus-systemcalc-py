...
class MotorDriveTest(TestSystemCalcBase):
	...
	def test_multi_drive(self):
		...
		self._set_setting('/Settings/Gui/ElectricPropulsionUI/MultiDrive/Left/DeviceInstance', 1)
		self._set_setting('/Settings/Gui/ElectricPropulsionUI/MultiDrive/Right/DeviceInstance', 2)
	...
	def test_multi_drive_power_inference(self):
		self._addFirstMotorDrive()
		self._addSecondMotorDrive()
		self._monitor.set_value('com.victronenergy.motordrive.ttyX1', '/Dc/0/Power', None)
