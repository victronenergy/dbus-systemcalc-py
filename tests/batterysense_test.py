...
class VoltageSenseTest(TestSystemCalcBase):
	...
	def test_forced_settings(self):
		...
		# Pylontech, BYD, FreedomWON, Discover AES, BlueNova, BSL-BATT, BMZ, DYNESS
		for product_id in (0xB009, 0xB00A, 0xB014, 0xB015, 0xB016, 0xB019, 0xB020, 0xB021, 0xB005, 0xB025):
			self._add_device('com.victronenergy.battery.ttyO2',
				product_name='battery',
				values={
					'/Dc/0/Voltage': 12.15,
