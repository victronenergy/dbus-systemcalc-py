...
class RM1(S2ResourceManagerItem):        
    def __init__(self, path:str, asset_details:AssetDetails, service:Service):
        self.ct_ombc = OMBCT_1(self)    
        self.ct_noctrl = CTNOCTRL_1(self)
        self.s2_path = path
        self.asset_details = asset_details
        self.service = service
        super().__init__(self.s2_path, [self.ct_noctrl], self.asset_details)
...
if __name__ == "__main__":
    ...
    async def main():
        ...
        service.add_item(IntegerItem('/Devices/0/S2/Priority', 35)) #Priority , EMS will read
        service.add_item(IntegerItem('/Devices/0/S2/ConsumerType', 1)) # 0=primary load, 1=secondary load, EMS will read
        
        service.add_item(IntegerItem('/Devices/1/S2/Priority', 40)) #Priority , EMS will read
        service.add_item(IntegerItem('/Devices/1/S2/ConsumerType', 1)) # 0=primary load, 1=secondary load, EMS will read
